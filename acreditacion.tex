...
\end{titlepage}
   ...
   \pagestyle{fancy}
   \fancyhead[LO,CE]{\includegraphics[scale=0.27]{img/logo_umcc2.png} \begin{minipage}{0.5\textwidth} % 60% de la p�g
   		\begin{flushleft}
   			\vspace*{-0.4in}
   ...
   \addcontentsline{toc}{chapter}{\large CARACTERIZACI\'ON DE LA CARRERA GESTI\'ON SOCIOCULTURAL PARA EL DESARROLLO} 
   \chapter*{CARACTERIZACI\'ON DE LA CARRERA GESTI\'ON SOCIOCULTURAL PARA EL DESARROLL}
   \input{tex_files/caracterizacion}
    \pagebreak
   
   \addcontentsline{toc}{chapter}{\large VARIABLE 1: PERTINENCIA E IMPACTO SOCIAL}
   \chapter*{VARIABLE 1: PERTINENCIA E IMPACTO SOCIAL}
   \input{tex_files/variable_1}
   \pagebreak
   
   \addcontentsline{toc}{chapter}{\large VARIABLE 2: PROFESORES Y PERSONAL AUXILIAR}
   \chapter*{VARIABLE 2: PROFESORES Y PERSONAL AUXILIAR}
   \input{tex_files/variable_2}
    \pagebreak
   
   \addcontentsline{toc}{chapter}{\large VARIABLE 3: ESTUDIANTES}
   \chapter*{VARIABLE 3: ESTUDIANTES}
   \input{tex_files/variable_3}
    \pagebreak
   
   \addcontentsline{toc}{chapter}{\large VARIABLE 4: INFRAESTRUCTURA}
   \chapter*{VARIABLE 4: INFRAESTRUCTURA}
   \input{tex_files/variable_4}
    \pagebreak
   
   \addcontentsline{toc}{chapter}{\large VARIABLE 5: CURR\'ICULO}
   \chapter*{VARIABLE 5: CURR\'ICULO}
   \input{tex_files/variable_5}
    \pagebreak
  
  \addcontentsline{toc}{chapter}{\large ANEXO}
  \chapter*{ANEXO}
  \input{tex_files/anexo}
  \pagebreak
